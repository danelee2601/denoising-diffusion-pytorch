...
def compute_downsample_rate(input_length: int, downsampled_width: int):
    return round(input_length / downsampled_width) if input_length >= downsampled_width else 1
